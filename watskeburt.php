<?php
/*
Plugin Name: Watskeburt? <em>(je weet prec&iacute;es hoe laat het is)</em>
Plugin URI: https://github.com/stronk/wordpress-plugin-watskeburt/
Description: Elke keer een andere frase uit deze frisse zomerhit, een fr&ecirc;le bloempje uit het frisse boeket dat het zo rijke &oelig;uvre van de Jeugd van Tegenwoordig vormt
Version: 1.04
Author: Stronk
...
License: GPL2
    ...
    Copyright 2011-2012  Stronk  (email: koen@stronk.net)
